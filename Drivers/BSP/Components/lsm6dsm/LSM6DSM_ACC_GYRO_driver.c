...
/*******************************************************************************
* Function Name  : LSM6DSM_ACC_GYRO_W_BW0_XL
* Description    : Write BW0_XL
* Input          : LSM6DSM_ACC_GYRO_BW0_XL_t
* Output         : None
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/
status_t  LSM6DSM_ACC_GYRO_W_BW0_XL(void *handle, LSM6DSM_ACC_GYRO_BW0_XL_t newValue)
{
  u8_t value;
  ...
  value &= ~LSM6DSM_ACC_GYRO_BW0_XL_MASK; 
  value |= newValue;
...
/*******************************************************************************
* Function Name  : LSM6DSM_ACC_GYRO_R_BW0_XL
* Description    : Read BW0_XL
* Input          : Pointer to LSM6DSM_ACC_GYRO_BW0_XL_t
* Output         : Status of BW_SEL see LSM6DSM_ACC_GYRO_BW0_XL_t
* Return         : Status [MEMS_ERROR, MEMS_SUCCESS]
*******************************************************************************/

status_t LSM6DSM_ACC_GYRO_R_BW0_XL(void *handle, LSM6DSM_ACC_GYRO_BW0_XL_t *value)
{
 if( !LSM6DSM_ACC_GYRO_ReadReg(handle, LSM6DSM_ACC_GYRO_CTRL1_XL, (u8_t *)value) )
    return MEMS_ERROR;

  *value &= LSM6DSM_ACC_GYRO_BW0_XL_MASK; //mask
...
status_t LSM6DSM_ACC_Get_Acceleration(void *handle, int *buff, u8_t from_fifo)
{
  ...
  /* Apply proper shift and sensitivity */
  buff[0] = (raw_data_tmp.i16bit[0] * sensitivity + 500)/(float)1000;
  buff[1] = (raw_data_tmp.i16bit[1] * sensitivity + 500)/(float)1000;
  buff[2] = (raw_data_tmp.i16bit[2] * sensitivity + 500)/(float)1000;
