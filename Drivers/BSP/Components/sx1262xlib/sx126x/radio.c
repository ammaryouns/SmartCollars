                         ...
                         bool iqInverted, bool rxContinuous )
{
    ...
    switch( modem )
    {
        ...
        case MODEM_LORA:
            ...
            SX126x.ModulationParams.Params.LoRa.Bandwidth = bandwidth;
            SX126x.ModulationParams.Params.LoRa.CodingRate = ( RadioLoRaCodingRates_t )coderate;

            if( ( ( bandwidth == LORA_BW_007 ) && ( ( datarate == LORA_SF11 ) || ( datarate == LORA_SF12 ) ) ) ||
            ( ( bandwidth == LORA_BW_015 ) && ( datarate == LORA_SF12 ) ) )
            {
...
void RadioRx( uint32_t timeout )
{
    ...
    SX126xSetDioIrqParams( IrqMask, //IRQ_RX_DONE | IRQ_RX_TX_TIMEOUT,
