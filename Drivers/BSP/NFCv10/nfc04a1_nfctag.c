...
/** @defgroup NFC04A1_NFCTAG
 * @{
 */
/* Private typedef -----------------------------------------------------------*/
/* Private defines -----------------------------------------------------------*/
/** @defgroup NFC04A1_NFCTAG_Private_Defines
 * @{
 */
#ifndef NULL
#define NULL      (void *) 0
...
/* Private variables ---------------------------------------------------------*/ 
/* Global variables ----------------------------------------------------------*/
/** @defgroup NFC04A1_NFCTAG_Private_Variables
 * @{
 */
...
/** @defgroup NFC04A1_NFCTAG_Public_Functions
 * @{
 */
/**
...
{ 
  ...
  if( !NfctagInitialized )
  {
    ...
    {    
      printTask("NFC chip i2c communication ok");  
      printTask("NFC chip is present [%02X]", nfctag_id);
      NfctagInitialized = 1;
    ...
    { 
      printTask("NFC chip i2c communication failed"); 
      Nfctag_Drv = NULL;
      NfctagInitialized = 0;
      return NFCTAG_ERROR;
    }
